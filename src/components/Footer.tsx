      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-3">
            <a href="#" className="p-2 rounded-lg border border-[var(--card-border)] hover:border-[#00d4ff]/50 transition-colors" aria-label="Twitter/X">
            ...
            <a href="#" className="p-2 rounded-lg border border-[var(--card-border)] hover:border-[#00d4ff]/50 transition-colors" aria-label="Instagram">
            ...
            <a href="#" className="p-2 rounded-lg border border-[var(--card-border)] hover:border-[#00d4ff]/50 transition-colors" aria-label="YouTube">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" className="text-[#64748b]">
        ...
        {/* Bottom */}
        <div className="mt-8 pt-6 border-t border-[var(--card-border)] flex flex-col sm:flex-row items-center justify-between gap-2">
